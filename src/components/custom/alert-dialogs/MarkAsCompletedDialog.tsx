...
const MarkAsCompletedDialog = React.forwardRef<HTMLButtonElement, ThisComponentProps>(
  ({ data, onAction }, ref) => {
    ...
    return (
      <AlertDialog>
        <AlertDialogTrigger asChild>
          <Button ref={ref} variant="ghost" className=" justify-start px-2">Mark as Completed</Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
          <AlertDialogHeader>
...
MarkAsCompletedDialog.displayName = "MarkAsCompletedDialog"
