...
export default function HowItWorks() {
  return (
    <section className="py-36 px-4 max-w-6xl mx-auto scroll-pt-20" id="howitworks">
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-between gap-8 md:gap-4">
        {HowItWorksSteps.map((step, index) => (
          <div key={index} className="flex flex-col items-center text-center max-w-sm">
            <div className="relative z-10 p-4 bg-blue-100 dark:bg-blue-600 rounded-full mb-4 text-red-400">
              {step.icon}
            </div>
